...
Re-run this any time to refresh data_source/fantasy_prices/basketballsphere_prices.csv --
...
DEFAULT_OUT = Path(__file__).resolve().parents[1] / "data_source" / "fantasy_prices" / "basketballsphere_prices.csv"
