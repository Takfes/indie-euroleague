...
- Data: raw downloads live in `data/source_data/<source>/` and are git-ignored; produced tables live in `data/curated_data/`, the only tracked data folder. Only the basketballsphere prices have a fetcher in `src/`; the other source folders are recoverable from the `archive/v2-2026-09` tag.
